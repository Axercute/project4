...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/" | "/admin" | "/admin/login" | "/admin/login/appointment" | "/admin/login/appointment/[appointmentId]" | "/api" | "/api/appointment" | "/api/appointment/[appointmentId]" | "/api/dataInput" | "/api/login" | "/api/login/profileUpdate" | "/api/protection" | "/api/service" | "/booking" | "/booking/[appointmentId]" | "/contactUs" | "/dashboard" | "/dashboard/appointment" | "/dashboard/appointment/[appointmentId]" | "/dashboard/service-management" | "/pricing" | "/test";
		RouteParams(): {
