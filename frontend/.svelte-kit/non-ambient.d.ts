...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/" | "/admin" | "/admin/login" | "/admin/login/customers" | "/admin/login/customers/[appointmentId]" | "/admin/login/service-management" | "/admin/login/services" | "/admin/login/testing" | "/api" | "/api/appointment" | "/api/appointment/[appointmentId]" | "/api/dataInput" | "/api/login" | "/api/login/profileUpdate" | "/api/protection" | "/api/service" | "/booking" | "/booking/[appointmentId]" | "/contactUs" | "/pricing" | "/test";
		RouteParams(): {
		...
		Pathname(): "/" | "/admin" | "/admin/" | "/admin/login" | "/admin/login/" | "/admin/login/customers" | "/admin/login/customers/" | `/admin/login/customers/${string}` & {} | `/admin/login/customers/${string}/` & {} | "/admin/login/service-management" | "/admin/login/service-management/" | "/admin/login/services" | "/admin/login/services/" | "/admin/login/testing" | "/admin/login/testing/" | "/api" | "/api/" | "/api/appointment" | "/api/appointment/" | `/api/appointment/${string}` & {} | `/api/appointment/${string}/` & {} | "/api/dataInput" | "/api/dataInput/" | "/api/login" | "/api/login/" | "/api/login/profileUpdate" | "/api/login/profileUpdate/" | "/api/protection" | "/api/protection/" | "/api/service" | "/api/service/" | "/booking" | "/booking/" | `/booking/${string}` & {} | `/booking/${string}/` & {} | "/contactUs" | "/contactUs/" | "/pricing" | "/pricing/" | "/test" | "/test/";
