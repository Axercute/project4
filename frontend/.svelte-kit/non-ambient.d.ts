...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/" | "/admin" | "/admin/login" | "/admin/login/appointment" | "/admin/login/appointment/[appointmentId]" | "/admin/login/services" | "/admin/login/testing" | "/api" | "/api/appointment" | "/api/appointment/[appointmentId]" | "/api/dataInput" | "/api/login" | "/api/login/profileUpdate" | "/api/protection" | "/api/service" | "/booking" | "/booking/[appointmentId]" | "/contactUs" | "/dashboard" | "/dashboard/appointment" | "/dashboard/appointment/[appointmentId]" | "/dashboard/service-management" | "/pricing" | "/test";
		RouteParams(): {
			"/admin/login/appointment/[appointmentId]": { appointmentId: string };
		...
		LayoutParams(): {
			...
			"/admin/login/appointment": { appointmentId?: string };
			"/admin/login/appointment/[appointmentId]": { appointmentId: string };
		...
		Pathname(): "/" | "/admin" | "/admin/" | "/admin/login" | "/admin/login/" | "/admin/login/appointment" | "/admin/login/appointment/" | `/admin/login/appointment/${string}` & {} | `/admin/login/appointment/${string}/` & {} | "/admin/login/services" | "/admin/login/services/" | "/admin/login/testing" | "/admin/login/testing/" | "/api" | "/api/" | "/api/appointment" | "/api/appointment/" | `/api/appointment/${string}` & {} | `/api/appointment/${string}/` & {} | "/api/dataInput" | "/api/dataInput/" | "/api/login" | "/api/login/" | "/api/login/profileUpdate" | "/api/login/profileUpdate/" | "/api/protection" | "/api/protection/" | "/api/service" | "/api/service/" | "/booking" | "/booking/" | `/booking/${string}` & {} | `/booking/${string}/` & {} | "/contactUs" | "/contactUs/" | "/dashboard" | "/dashboard/" | "/dashboard/appointment" | "/dashboard/appointment/" | `/dashboard/appointment/${string}` & {} | `/dashboard/appointment/${string}/` & {} | "/dashboard/service-management" | "/dashboard/service-management/" | "/pricing" | "/pricing/" | "/test" | "/test/";
