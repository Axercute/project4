...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    if (data) {
      ...
      Runtime($$renderer2, { x: _w_runtime_.cx(40), a: [data.appointment.name] });
      $$renderer2.push(`<!----></div> <div class="text-xl text-white font-semibold">`);
      Runtime($$renderer2, { t: [_w_snippet_0, _w_snippet_1], x: _w_runtime_.cx(41) });
      $$renderer2.push(`<!----></div> <div><h3 class="text-xl font-semibold text-white mb-2">${escape_html(_w_runtime_.t(42))}</h3> <ol class="list-decimal list-inside text-green-400"><!--[-->`);
      ...
      if (data.appointment.extraComments) {
        $$renderer2.push("<!--[-->");
        $$renderer2.push(`<div class="font-semibold text-xl text-white">${escape_html(_w_runtime_.t(43))}</div> <div class="font-semibold text-white">${escape_html(data.appointment.extraComments)}</div>`);
      } else {
        $$renderer2.push("<!--[!-->");
      }
      $$renderer2.push(`<!--]--> <button class="text-black flex-center bg-green-400 hover:bg-green-800">${escape_html(_w_runtime_.t(44))}</button></div></div>`);
    } else {
      $$renderer2.push("<!--[!-->");
